        ...
        <div class="col-md-12">
          <div class="card ">
            <div class="card-header card-header-rose card-header-text">
              <div class="card-text">
                <h4 class="card-title">Venta de dolares</h4>
              </div>
            </div>
            <div class="card-body ">
              <div class="row">
              ...
              <div class="row">
                ...
                <div class="col-sm-10">
                  <div class="form-group">
                    <input required type="text" class="form-control" value="0" id="pesosAmount" disabled>
                  </div>
                </div>
              </div>
...
<script>
  ...
  const onAmountChange = value => {
    $('#pesosAmount').val("$" + (Math.round(((value * ${ saleValue }) + Number.EPSILON) * 100) / 100));
  }
</script>