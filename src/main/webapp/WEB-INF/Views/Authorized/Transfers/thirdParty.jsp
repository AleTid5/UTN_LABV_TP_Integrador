        ...
        <div class="col-md-12">
          <div class="card ">
            <div class="card-header card-header-rose card-header-text">
              <div class="card-text">
                <h4 class="card-title">Agregar Préstamo</h4>
              </div>
            </div>
            <div class="card-body ">
              <div class="row">
...
<script>
  ...
  const onAccountChange = select => {
    options.maxValue = parseFloat(select.options[select.selectedIndex].getAttribute('data-value'));
    $('[name="amount"]').attr("max", options.maxValue);
