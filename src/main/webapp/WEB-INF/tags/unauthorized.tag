...
<div id="app" class="wrapper wrapper-full-page">
	<div class="page-header login-page header-filter" filter-color="black"
		 style="background-image: url('http://localhost:8085/UTN_LABV_TP_Integrador/App/Assets/img/login.jpg'); background-size: cover; background-position: top center;">
		<div class="container">
...
<script src="http://localhost:8085/UTN_LABV_TP_Integrador/App/Assets/js/components/login.js"></script>
</body>
</html>